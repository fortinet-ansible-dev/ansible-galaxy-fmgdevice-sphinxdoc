...
.. raw:: html
 ...
 <li><span class="li-head">sub_type</span> <b>(Alias name: sub-type)</b>  Sub-type of address. <span class="li-normal">type: str</span> <span class="li-normal">choices: [sdn, clearpass-spt, fsso, ems-tag, swc-tag, fortivoice-tag, fortinac-tag, fortipolicy-tag, device-identification, external-resource, rsso, obsolete, telemetry, 8021x]</span>
 ...
 <li><span class="li-head">type</span> Type of address. <span class="li-normal">type: str</span> <span class="li-normal">choices: [ipmask, iprange, fqdn, wildcard, geography, dynamic, interface-subnet, fqdn-group, route-tag, mac, wildcard-fqdn, ipam]</span>
 ...
 <li><span class="li-head">display_with</span> <b>(Alias name: display-with)</b>  Display object with first tag, all tags, or just the icon & color. <span class="li-normal">type: str</span> <span class="li-normal">choices: [all-tags, first-tag-only, icon-and-color]</span>
 ...
 <li><span class="li-head">hw_version</span> <b>(Alias name: hw-version)</b>  Dynamic address matching hardware version. <span class="li-normal">type: str</span>
 <a id='label144' href="javascript:ContentClick('label145', 'label144');" onmouseover="ContentPreview('label145');" onmouseout="ContentUnpreview('label145');" title="click to collapse or expand..."> more... </a>
 <div id="label145" style="display:none">
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v8.0.0 -> latest</code></p>
 </div>
 </li>
 <li><span class="li-head">ipam_allocate_unique</span> <b>(Alias name: ipam-allocate-unique)</b>  Allocate unique subnet for fortiipam managed fabric-object address. <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, enable]</span>
 ...
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v7.4.8 -> v7.4.11</code>, <code class="docutils literal notranslate">v7.6.4 -> v7.6.7</code></p>
 </div>
 </li>
 <li><span class="li-head">start_mac</span> <b>(Alias name: start-mac)</b>  Support meta variable <span class="li-normal">type: str</span>
      ...
      - name: Configure IPv4 addresses.
        fortinet.fmgdevice.fmgd_firewall_address:
          ...
          firewall_address:
            ...
            #     tag_uuid: <string>
            #     passive_fqdn_learning: <value in [disable, enable]>
            #     obsolete: <integer>
            ...
            #     hw_version: <string>
            #     ipam_allocate_unique: <value in [disable, enable]>
            #     managed_subnetwork_size: <value in [4, 8, 16, ...]>
            # end_ip: <string>
            # epg_name: <string>
            # fabric_object: <value in [disable, enable]>
            # filter: <string>
