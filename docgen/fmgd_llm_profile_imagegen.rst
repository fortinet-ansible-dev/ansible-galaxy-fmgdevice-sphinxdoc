...
.. raw:: html
 ...
 <li><span class="li-head">llm_profile_imagegen</span> - Device vdom llm profile image gen <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Device vdom llm profile image gen
