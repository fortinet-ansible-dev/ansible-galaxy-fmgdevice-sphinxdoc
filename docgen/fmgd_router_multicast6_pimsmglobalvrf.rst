:source: fmgd_router_multicast6_pimsmglobalvrf.py

:orphan:

.. _fmgd_router_multicast6_pimsmglobalvrf:

fmgd_router_multicast6_pimsmglobalvrf -- per-VRF PIM sparse-mode global settings.
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">router_multicast6_pimsmglobalvrf</span> - per-VRF PIM sparse-mode global settings. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">bsr_hash</span> <b>(Alias name: bsr-hash)</b>  Bsr hash length (0 - 128, default = 126). <span class="li-normal">type: int</span>
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Per-VRF PIM sparse-mode global settings.
        fortinet.fmgdevice.fmgd_router_multicast6_pimsmglobalvrf:
          # workspace_locking_adom: <global or your adom name>
          device: <your own value>
          vdom: <your own value>
          state: present # <value in [present, absent]>
          router_multicast6_pimsmglobalvrf:
