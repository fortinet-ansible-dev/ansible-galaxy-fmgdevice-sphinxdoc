...
.. raw:: html
 ...
 <li><span class="li-head">internet_service_name</span> <b>(Alias name: internet-service-name)</b>  Name of internet service. <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">route_map_evpn</span> <b>(Alias name: route-map-evpn)</b>  Route map name for evpn redistribution. <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">status_evpn</span> <b>(Alias name: status-evpn)</b>  Evpn redistribution status. <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, enable]</span>
 ...
 <li><span class="li-head">dampening6</span> Enable/disable ipv6 route-flap dampening. <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, enable]</span>
 ...
 <li><span class="li-head">dampening6_max_suppress_time</span> <b>(Alias name: dampening6-max-suppress-time)</b>  Maximum minutes an ipv6 route can be suppressed. <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">dampening6_reachability_half_life</span> <b>(Alias name: dampening6-reachability-half-life)</b>  Ipv6 reachability half-life time for penalty (min). <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">dampening6_reuse</span> <b>(Alias name: dampening6-reuse)</b>  Threshold to reuse ipv6 routes. <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">dampening6_route_map</span> <b>(Alias name: dampening6-route-map)</b>  Criteria for ipv6 dampening. <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">dampening6_suppress</span> <b>(Alias name: dampening6-suppress)</b>  Threshold to suppress ipv6 routes. <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">dampening6_unreachability_half_life</span> <b>(Alias name: dampening6-unreachability-half-life)</b>  Ipv6 unreachability half-life time for penalty (min). <span class="li-normal">type: int</span>
      ...
      - name: Configure BGP.
        fortinet.fmgdevice.fmgd_router_bgp:
          ...
          router_bgp:
            ...
            #   route_map_evpn: <list or string>
            #   status_evpn: <value in [disable, enable]>
            # redistribute6:
            #   name: <string>
            #   route_map: <list or string>
            #   status: <value in [disable, enable]>
            ...
            # dampening6: <value in [disable, enable]>
            # dampening6_max_suppress_time: <integer>
            # dampening6_reachability_half_life: <integer>
            # dampening6_reuse: <integer>
            # dampening6_route_map: <list or string>
            # dampening6_suppress: <integer>
            # dampening6_unreachability_half_life: <integer>
            # display_options: <integer>
