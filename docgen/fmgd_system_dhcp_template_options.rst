:source: fmgd_system_dhcp_template_options.py

:orphan:

.. _fmgd_system_dhcp_template_options:

fmgd_system_dhcp_template_options -- DHCP options.
++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">system_dhcp_template_options</span> - DHCP options. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: DHCP options.
        fortinet.fmgdevice.fmgd_system_dhcp_template_options:
          # workspace_locking_adom: <global or your adom name>
          device: <your own value>
          template: <your own value>
          state: present # <value in [present, absent]>
          system_dhcp_template_options:
