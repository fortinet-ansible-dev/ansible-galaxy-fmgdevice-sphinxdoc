...
.. raw:: html
 ...
 <li><span class="li-head">type</span> Address group type. <span class="li-normal">type: str</span> <span class="li-normal">choices: [default, folder, array, dynamic-tag]</span>
      ...
      - name: Configure IPv4 address groups.
        fortinet.fmgdevice.fmgd_firewall_addrgrp:
          ...
          firewall_addrgrp:
            ...
            #     name: <string>
            #     tags: <list or string>
            # type: <value in [default, folder, dynamic-tag]>
            # uuid: <string>
            # global_object: <integer>
            # visibility: <value in [disable, enable]>
            # tags: <list or string>
