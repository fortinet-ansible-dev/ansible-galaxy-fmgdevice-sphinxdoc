:source: fmgd_system_ha_linkgroup.py

:orphan:

.. _fmgd_system_ha_linkgroup:

fmgd_system_ha_linkgroup -- Link group table.
+++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">system_ha_linkgroup</span> - Link group table. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    gather_facts: false
    tasks:
      - name: Link group table.
        fortinet.fmgdevice.fmgd_system_ha_linkgroup:
