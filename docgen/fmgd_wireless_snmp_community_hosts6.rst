:source: fmgd_wireless_snmp_community_hosts6.py

:orphan:

.. _fmgd_wireless_snmp_community_hosts6:
...
.. raw:: html
 ...
 <li><span class="li-head">wireless_snmp_community_hosts6</span> - Configure IPv6 SNMP managers <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure IPv6 SNMP managers
        fortinet.fmgdevice.fmgd_wireless_snmp_community_hosts6:
          # workspace_locking_adom: <global or your adom name>
          device: <your own value>
          vdom: <your own value>
          community: <your own value>
          state: present # <value in [present, absent]>
          wireless_snmp_community_hosts6:
